...
const NEXT_CONFIG = {
  ...
  env: {
    ...
    FIELD_TRIP_KAKAO_REDIRECT_URI_LOGIN:
      processEnv.FIELD_TRIP_KAKAO_REDIRECT_URI_LOGIN,
    FIELD_TRIP_KAKAO_REDIRECT_URI_SIGNUP:
      processEnv.FIELD_TRIP_KAKAO_REDIRECT_URI_SIGNUP,
